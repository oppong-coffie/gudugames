    ...
    <nav className="flex items-center px-[5vw] py-4 md:px-[9vw] bg-black">
              ...
              <SheetDescription>
                <ul className='mt-[8vh] flex flex-col w-full gap-5 px-6 py-1'>
                  ...
                  <li className="text-center my-5">
                    <button onClick={() => { setIsLoginModalOpen(true); setIsOpen(false); }} className="px-12 py-3 rounded-full border bg-black text-white ">Log In</button>
                  </li>
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-zinc-900 border border-zinc-700 rounded-3xl p-8 max-w-sm w-full shadow-2xl relative animate-in fade-in zoom-in duration-300">
            <button
            ...
            <div className="flex flex-col items-center mb-6">
              <img src={Images.gudulogo} className="h-10 mb-4" alt="Gudu Games" />
            </div>
            ...
            <div className="flex flex-col gap-4">
              <Link
                ...
                className="flex items-center justify-center w-full bg-[#DECD00] hover:bg-yellow-400 text-black font-semibold rounded-xl px-4 py-4 transition-all duration-300 transform hover:-translate-y-1 shadow-[0_0_15px_rgba(222,205,0,0.2)]"
              >
              ...
              <Link
                ...
                className="flex items-center justify-center w-full bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-xl px-4 py-4 transition-all duration-300 transform hover:-translate-y-1 border border-zinc-700 hover:border-zinc-500 shadow-[0_0_15px_rgba(255,255,255,0.05)]"
              >
